...
<div class="container">
    <h5><i class="material-icons">shopping_cart</i> Ваша корзина (20 товара(ов))</h5>
    <div class="row"></div>
    <ul class="collapsible" data-collapsible="accordion">
        ...
        <li>
            ...
            <div class="collapsible-body">
                ...
                <div class="col s2">
                    <input  type="number" size="3" name="addnum" min="0" value="1">
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col s2">
                        <input  type="number" size="3" name="decnum" min="0" value="1">
                    </div>
                    <div class="col s3" style="padding-top: 10px">
                        <button class="btn waves-effect waves-light" type="submit" name="action">Dec
                            <i class="material-icons right">remove</i>
                        </button>
                    </div>
                </div>
                <div class="row center-align"><a href="#">Удалить</a> </div>
            </div>
        </li>
        <?php
        for($i=0; $i < 5; $i++)
    ...
    <ul class="collapsible" data-collapsible="accordion">
        ...
        <li>
            <div class="collapsible-header">
                <div class="container">
                    <div class="row">
                        <div class="col s3 left-align"><b>Packing</b></div>
                        <div class="col s2 center-align"></div>
                        <div class="col s2 center-align"></div>
                        <div class="col s2 left-align"><b>Total:</b></div>
                        <div class="col s1 center-align">5128.81</div>
                        <div class="col s2 center-align"><span class="new badge red" data-badge-caption="">Сумма</span></div>
                    </div>
                </div>
            </div>
        </li>
